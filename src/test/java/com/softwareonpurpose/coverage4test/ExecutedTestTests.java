...
public class ExecutedTestTests {
    ...
    public void testGetInstance_withScenario() {
        ...
        Class actual = ExecutedTest.getInstance("test 1", "feature 1", Scenario.getInstance("scenario 1"), 1).getClass();
    ...
    public void testGetInstance_withNullOrEmptyTestName(String testName) {
        ...
        ExecutedTest actual = ExecutedTest.getInstance(testName, "feature", Scenario.getInstance(2), 1);
    ...
    public void testEquals_self() {
        ...
        ExecutedTest test = ExecutedTest.getInstance("test 1", "feature 1", Scenario.getInstance("scenario 1"), 1);
    ...
    public void testEquals_duplicateObjects() {
        ExecutedTest test_1 = ExecutedTest.getInstance("test 1", "feature 1", Scenario.getInstance("scenario 1"), 1);
        ExecutedTest test_2 = ExecutedTest.getInstance("test 1", "feature 1", Scenario.getInstance("scenario 1"), 1);
    ...
    public void testCompareTo_sameTestName() {
        ExecutedTest test_1 = ExecutedTest.getInstance("test", "feature 1", Scenario.getInstance("scenario 1"), 1);
        ExecutedTest test_2 = ExecutedTest.getInstance("test", "feature 1", Scenario.getInstance("scenario 1"), 1);
    ...
    public void testCompareTo_differentTestName() {
        ExecutedTest test_1 = ExecutedTest.getInstance("test 1", "feature 1", Scenario.getInstance("scenario 1"), 1);
        ExecutedTest test_2 = ExecutedTest.getInstance("test 2", "feature 1", Scenario.getInstance("scenario 1"), 1);
